...
dialog.add(spr_bennytalkingneutral, "Welp, I guess we're still doing this.");
dialog.add(spr_willytalkingneutral, "It appears so, yes. I have been instructed to give you your next clue.");
...
dialog.add(spr_willytalkingneutral, "Okay, same thing as last time. Should be easy enough.");
...
dialog.add(spr_bennytalkingneutral, "I'm sure I can manage. Seeya, Willy.");

global._willyfloor2dia1 = false