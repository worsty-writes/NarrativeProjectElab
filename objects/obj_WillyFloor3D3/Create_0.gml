...
dialog.add(spr_bennytalkingneutral, "Willy, what the hell am I looking at here?");
dialog.add(spr_willytalkingneutral, "A QR code.");
dialog.add(spr_bennytalkingneutral, "Okay, but what do I do with that QR code?");
dialog.add(spr_willytalkingneutral, "That I cannot say, Master Benjamin, but I can say this:");
