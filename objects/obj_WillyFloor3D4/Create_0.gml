...
dialog.add(spr_willytalkingneutral, "Ah. So I see you have completed the final puzzle, Master Benjamin.");
dialog.add(spr_bennytalkingneutral, "Yeah, took me long enough. God, if I'm late for this thing...");
dialog.add(spr_willytalkingneutral, "I can see how that would be frustrating. Either way, I hope you have a wonderful time at your daughter's dance recital.");
